  ...
  const save = async () => {
    ...
    try {
      ...
      if (editing) {
        ...
        await API.put(
          `/admin/config/platform-fees/${editing.id}`,
          payload
        );
  ...
  return (
    ...
    <AdminLayout>
      ...
      <AdminPageHeader
        ...
        description="
          Manage flat and percentage
          based platform commissions
          for customer orders.
        "
      />
